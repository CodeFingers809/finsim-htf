...
function calculateIndicators(quote: MarketQuote) {
    ...
    const bollingerPosition =
        ((price - bollingerLower) / (bollingerUpper - bollingerLower)) * 100;
        ...
        return (
            <div className="space-y-3">
                ...
                {[1, 2].map((i) => (
                    <div
                        key={i}
                        className="h-48 rounded-xl bg-[#1a1d24] animate-pulse"
                    />
                ))}
            </div>
        );
                    ...
                    >
                            ...
                            <div className="rounded-lg bg-[#2d303a]/30 p-2">
                                ...
                                <p
                                    className={cn(
                                        ...
                                        indicators.macdValue > 0
                                            ? "text-[#3dd68c]"
                                            : "text-[#f06c6c]"
                                    )}
                                >
                                    {(indicators?.macdValue ?? 0) > 0
                                        ? "+"
                                        : ""}
                            ...
                            <div className="rounded-lg bg-[#2d303a]/30 p-2">
                                ...
                                >
                                    {(indicators?.priceVsSMA20 ?? 0) > 0
                                        ? "+"
                                        : ""}
                                    {indicators?.priceVsSMA20?.toFixed(2) ??
                                        "--"}
                                    % from price
                                </p>
                            </div>
                            ...
                            <div className="rounded-lg bg-[#2d303a]/30 p-2">
                                ...
                                >
                                    {(indicators?.priceVsSMA50 ?? 0) > 0
                                        ? "+"
                                        : ""}
                                    {indicators?.priceVsSMA50?.toFixed(2) ??
                                        "--"}
                                    % from price
                                </p>
                            </div>
                        ...
                        <div className="rounded-lg bg-[#2d303a]/30 p-2.5 mb-2">
                            <div className="flex items-center justify-between mb-2">
                                <span className="text-[10px] font-medium text-[#8b8f9a]">
                                    Bollinger Bands
                                </span>
                                <span className="text-[10px] text-[#8b8f9a]">
                            ...
                            <div className="space-y-1.5">
                                <div className="flex justify-between text-[9px] text-[#8b8f9a]">
                                    <span>
                                        Lower: ₹
                                        {indicators?.bollingerLower?.toFixed(
                                            2
                                        ) ?? "--"}
                                    </span>
                                    <span>
                                        Mid: ₹
                                        {indicators?.bollingerMiddle?.toFixed(
                                            2
                                        ) ?? "--"}
                                    </span>
                                    <span>
                                        Upper: ₹
                                        {indicators?.bollingerUpper?.toFixed(
                                            2
                                        ) ?? "--"}
                                    </span>
                                </div>
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-[#2d303a]/30">
                            <div>
                                ...
                                <span className="text-xs font-semibold font-mono text-[#3dd68c]">
                            ...
                            <div>
                                ...
                                <span className="text-xs font-semibold font-mono text-[#f06c6c]">
                                    ₹
