        ...
        <div className="p-5 space-y-5">
            ...
            <div className="flex items-center justify-center gap-3 p-4 rounded-xl bg-[#1a1d24]/80 border border-[#2d303a]/40">
                <div className="text-center">
                    ...
                    <p className={cn("text-xl font-bold", consensusColor)}>
                        {consensus}
                    </p>
            ...
            <div className="space-y-2.5">
                {[
                    ...
                    <div key={item.label} className="flex items-center gap-3">
                        <span className="text-[11px] text-[#8b8f9a] w-20">
                            {item.label}
                        </span>
                        ...
                        <span className="text-xs font-mono text-[#c0c4cc] w-6 text-right">
                            {item.count}
                        </span>
                    </div>
                ))}
            ...
            <div className="grid grid-cols-2 gap-3">
                <div className="p-3.5 rounded-xl bg-[#22c55e]/8 border border-[#22c55e]/20">
                    ...
                    <p className="text-[11px] text-[#3dd68c]/70">
                        {bullish} analysts
                    </p>
                </div>
                <div className="p-3.5 rounded-xl bg-[#ef4444]/8 border border-[#ef4444]/20">
                    ...
                    <p className="text-[11px] text-[#f06c6c]/70">
                        {bearish} analysts
                    </p>
                </div>
            </div>
                ...
                <div className="space-y-3 pt-3 border-t border-[#2d303a]/40">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <div className="p-2.5 rounded-xl bg-[#6c8cff]/10 text-center">
                            <p className="text-[11px] text-[#6c8cff]/80">
                                Average
                            </p>
